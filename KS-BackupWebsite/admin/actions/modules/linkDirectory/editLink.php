...
*****************************************/?>
<h1>Edit Requested Links</h1>
		<form name="form_link_request" method="post" action="#">
	...
	<tr><td colspan="2"></td></tr>
	  <tr>
		...
		<td width="70%" align="left" valign="middle">
			<input name="first_name" id="first_name" type="text" value= "<?php echo $data[0]['first_name'];?>"  style="width:50%">
        </td>
	  </tr>
	  <tr>
